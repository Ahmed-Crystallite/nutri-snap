...
const BestWay = () => {
  return (
    <section>
      <div className="relative z-30 lg:pt-[80px] md:pt-[60px] pt-[50px] sm:pb-0 pb-[50px] sm:bg-transparent bg-yellow">
        <div className="container">
          <div className="relative z-10 sm:px-5 sm:pt-10 sm:py-0">
            <span className="sm:absolute sm:-z-10 sm:inset-0 sm:block hidden bg-transparent sm:bg-yellow lg:h-[87%] sm:h-full sm:mt-auto sm:w-full sm:rounded-[30px]"></span>
